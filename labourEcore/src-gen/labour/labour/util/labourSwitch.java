...
public class labourSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case labourPackage.TRIANGLE: {
			...
			if (result == null)
				result = caseVolume(triangle);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case labourPackage.POSITION: {
		...
		case labourPackage.ANGULAR_POSITION: {
			AngularPosition angularPosition = (AngularPosition) theEObject;
			T result = caseAngularPosition(angularPosition);
			if (result == null)
				result = casePosition(angularPosition);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case labourPackage.CARTESIAN_POSITION: {
			CartesianPosition cartesianPosition = (CartesianPosition) theEObject;
			T result = caseCartesianPosition(cartesianPosition);
			if (result == null)
				result = casePosition(cartesianPosition);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Angular Position</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Angular Position</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAngularPosition(AngularPosition object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Cartesian Position</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Cartesian Position</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCartesianPosition(CartesianPosition object) {
		return null;
	}

...
/**
 * This is the item provider adapter for a {@link labour.labour.Volume} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VolumeItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addDepthPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Volume_depth_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Volume_depth_feature", "_UI_Volume_type"),
						labourPackage.Literals.VOLUME__DEPTH, true, false, false,
	...
	protected void addPosPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Volume_pos_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Volume_pos_feature", "_UI_Volume_type"),
						labourPackage.Literals.VOLUME__POS, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(labourPackage.Literals.VOLUME__POS);
		}
	...
	public String getText(Object object) {
		...
		return getString("_UI_Volume_type") + " " + volume.getDepth();
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(labourPackage.Literals.VOLUME__POS,
